...
exports.audioAndImages = images;
exports.build = series(cleanDist, buildDist, styles, scripts, html, otherFiles);
exports.default = parallel(styles, scripts, html, otherFiles);
